...
import { checkIsUserFollowed, followRequest, unfollowRequest } from "../../services/apiRequests";
...
export const HandleFollow = ({ id }) => {
    ...
    const renderButton =
        myUser === parseInt(id)
            ? null
            : (isFollowing
                ? <Button isLoading={loading} disabled={loading} onClick={handleClick}>Unfollow</Button>
                : <Button isLoading={loading} disabled={loading} unfollow onClick={handleClick}>Follow</Button>)
